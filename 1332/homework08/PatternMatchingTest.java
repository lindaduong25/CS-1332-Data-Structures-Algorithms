 ...
 *
 * I have included a single-match stress test. Feel free to play around
 * with the variables to see how different algorithms compare to each other.
 *
...
public class PatternMatchingTest {
    ...
    private static final int STRESS_TEST_TIMEOUT = 1000;        // Increase if you are getting timeout
    private static final int STRESS_TEST_ALPHABET_LENGTH = 26;  // Decrease to witness BM's downfall
    private static final int STRESS_TEST_PATTERN_LENGTH = 5;    // Increase to witness BM's return to glory
    private static final int STRESS_TEST_TEXT_LENGTH = 2000;    // Increase to really appreciate RK
    ...
    public void t14_KMP_PatternEqualsText() {
        ...
        assertTrue(comparator.getComparisonCount() == 5
    ...
    @Test(timeout = TIMEOUT)
    public void t34_RK_EqualHash() {
        test("rk", "\u0001\u0072", "\u0002\u0001\u0072",
                new int[] {1}, 3);
    }

    @Test(timeout = STRESS_TEST_TIMEOUT)
    public void t35_StressTest() {
    ...
    private void test(String algorithm, String pattern, String text, int[] matches, int comparisons) {
        ...
        assertEquals(comparisons, comparator.getComparisonCount());
    }

    private String generateString(int length) {
        StringBuilder builder = new StringBuilder(length);
        for (int j = 0; j < length; j++) {
            int randInt = 97 + rand.nextInt(STRESS_TEST_ALPHABET_LENGTH);
